...
TEST_CASE( "Valid Step data is parsed corectly", "[parser]" ) {
...
TEST_CASE( "Valid Relay data is parsed corectly", "[parser]" ) {
	t_relay relay_data;
...
TEST_CASE( "Valid Commands are parsed coreclty", "[parser]" ) {
...
TEST_CASE( "Steps activtion is working", "[step_perform]" ) {
	t_relay* relays = RelayApp_Start();
